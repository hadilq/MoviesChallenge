object Depends {
    ...
    const val archComponents = "androidx.lifecycle:lifecycle-extensions:${Versions.androidXLifecycleLib}"
    const val archComponentsCompiler = "androidx.lifecycle:lifecycle-compiler:${Versions.androidXLifecycleLib}"
